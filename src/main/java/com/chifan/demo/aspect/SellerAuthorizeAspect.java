package com.chifan.demo.aspect;
...
public class SellerAuthorizeAspect {
    ...
    @Pointcut("execution(public * com.chifan.demo.controller.Seller*.*(..))" +
            "&& !execution(public * com.chifan.demo.controller.SellerUserController.*(..))")
    public void verify() {}
